...
fetchData(`https://api.themoviedb.org/3/movie/${movieId}?append_to_response=videos%2Ccasts%2Cimages%2Creleases`,function(movie){
    console.log(movie);
    ...
    document.title = `${title} - TrailersNow`;
